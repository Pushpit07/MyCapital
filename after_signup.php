...
<html lang = "en">
    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                      <li class="nav-item active">
                        <a class="nav-link" href="index.php" style="font-size: 20px;">HomePage <span class="sr-only">(current)</span></a>
                      </li>
        ...
        <div class="layer">
          <div class="text">Great! You're now a member</div>
          <div class="text2">Please login to continue!</div>
        </div>
    </body>
</html>